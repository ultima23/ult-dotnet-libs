...
namespace Ult.Utils
{
  ...
  public class BitmapUtils
  {
    ...
    /// <summary>
    /// Convert a Bitmap object into a 32 byte per pixel ARGB format Bitmap object
    /// </summary>
    /// <param name="original">original image to convert</param>
    /// <returns>A copy for the original image in 32bppARGB format</returns>
    ...
    /// <summary>
    /// Convert a Bitmap image object into a bitonal image (black-white)
    /// </summary>
    /// <param name="original">Original image to convert</param>
    /// <returns>new bitonal image</returns>
